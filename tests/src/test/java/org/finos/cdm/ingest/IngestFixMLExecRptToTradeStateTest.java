...
public class IngestFixMLExecRptToTradeStateTest {

    @RegisterExtension
    static TransformTestExtension<Ingest_FixML_MessageToTradeState> testExtension =
            new TransformTestExtension<>(
                    new CdmRuntimeModuleTesting(),
                    INGEST_CONFIG_PATH,
                    Ingest_FixML_MessageToTradeState.class)
