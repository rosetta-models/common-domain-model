 ...
 *   &lt;complexContent&gt;
 *     &lt;extension base="{http://www.fpml.org/FpML-5/merged}SettlementTerms"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="valuationDate" type="{http://www.fpml.org/FpML-5/merged}ValuationDate" minOccurs="0"/&gt;
 *         &lt;element name="valuationTime" type="{http://www.fpml.org/FpML-5/merged}BusinessCenterTime" minOccurs="0"/&gt;
 *         &lt;element name="quotationMethod" type="{http://www.fpml.org/FpML-5/merged}QuotationRateTypeEnum" minOccurs="0"/&gt;
 *         &lt;element name="quotationAmount" type="{http://www.fpml.org/FpML-5/merged}Money" minOccurs="0"/&gt;
 *         &lt;element name="minimumQuotationAmount" type="{http://www.fpml.org/FpML-5/merged}Money" minOccurs="0"/&gt;
 *         &lt;element name="dealer" type="{http://www.fpml.org/FpML-5/merged}String" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="cashSettlementBusinessDays" type="{http://www.w3.org/2001/XMLSchema}nonNegativeInteger" minOccurs="0"/&gt;
 *         &lt;group ref="{http://www.fpml.org/FpML-5/merged}FixedRecovery.model" minOccurs="0"/&gt;
 ...
 *         &lt;element name="valuationMethod" type="{http://www.fpml.org/FpML-5/merged}ValuationMethodEnum" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
