 ...
 *       &lt;sequence&gt;
 *         &lt;group ref="{http://www.fpml.org/FpML-5/merged}PartyAndAccountReferences.model"/&gt;
 ...
 *         &lt;element name="unit" type="{http://www.fpml.org/FpML-5/merged}Unit" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="relatedBusinessUnit" type="{http://www.fpml.org/FpML-5/merged}RelatedBusinessUnit" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="relatedPerson" type="{http://www.fpml.org/FpML-5/merged}RelatedPerson" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="algorithm" type="{http://www.fpml.org/FpML-5/merged}Algorithm" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="isAccountingHedge" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/&gt;
 *         &lt;element name="category" type="{http://www.fpml.org/FpML-5/merged}TradeCategory" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="trader" type="{http://www.fpml.org/FpML-5/merged}Trader" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="executionDateTime" type="{http://www.fpml.org/FpML-5/merged}ExecutionDateTime" minOccurs="0"/&gt;
 *         &lt;element name="timestamps" type="{http://www.fpml.org/FpML-5/merged}TradeProcessingTimestamps" minOccurs="0"/&gt;
 *         &lt;element name="intentToAllocate" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/&gt;
 *         &lt;element name="allocationStatus" type="{http://www.fpml.org/FpML-5/merged}AllocationReportingStatus" minOccurs="0"/&gt;
 *         &lt;element name="intentToClear" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/&gt;
 *         &lt;element name="clearingStatus" type="{http://www.fpml.org/FpML-5/merged}ClearingStatusValue" minOccurs="0"/&gt;
 *         &lt;element name="collateralizationType" type="{http://www.fpml.org/FpML-5/merged}CollateralizationType" minOccurs="0"/&gt;
 *         &lt;element name="collateralPortfolio" type="{http://www.fpml.org/FpML-5/merged}PortfolioName" minOccurs="0"/&gt;
 *         &lt;element name="reportingRegime" type="{http://www.fpml.org/FpML-5/merged}ReportingRegime" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;choice&gt;
 *           &lt;sequence&gt;
 *             &lt;element name="endUserException" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/&gt;
 *             &lt;element name="endUserExceptionReason" type="{http://www.fpml.org/FpML-5/merged}ClearingExceptionReason" minOccurs="0"/&gt;
 *           &lt;/sequence&gt;
 *           &lt;element name="endUserExceptionDeclaration" type="{http://www.fpml.org/FpML-5/merged}EndUserExceptionDeclaration" minOccurs="0"/&gt;
 *         &lt;/choice&gt;
 ...
 *         &lt;element name="pricingContext" type="{http://www.fpml.org/FpML-5/merged}PricingContext" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="largeSizeTrade" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/&gt;
 *         &lt;element name="executionType" type="{http://www.fpml.org/FpML-5/merged}ExecutionType" minOccurs="0"/&gt;
 *         &lt;element name="executionVenueType" type="{http://www.fpml.org/FpML-5/merged}ExecutionVenueType" minOccurs="0"/&gt;
 *         &lt;element name="verificationMethod" type="{http://www.fpml.org/FpML-5/merged}VerificationMethod" minOccurs="0"/&gt;
 *         &lt;element name="confirmationMethod" type="{http://www.fpml.org/FpML-5/merged}ConfirmationMethod" minOccurs="0"/&gt;
 *         &lt;element name="compressedTrade" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/&gt;
 *         &lt;group ref="{http://www.fpml.org/FpML-5/merged}TransactionClassification.model" minOccurs="0"/&gt;
