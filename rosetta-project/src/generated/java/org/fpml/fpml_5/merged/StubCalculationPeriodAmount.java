 ...
 *       &lt;sequence&gt;
 *         &lt;element name="calculationPeriodDatesReference" type="{http://www.fpml.org/FpML-5/merged}CalculationPeriodDatesReference"/&gt;
 *         &lt;choice&gt;
 *           &lt;sequence&gt;
 *             &lt;element name="initialStub" type="{http://www.fpml.org/FpML-5/merged}StubValue"/&gt;
 *             &lt;element name="finalStub" type="{http://www.fpml.org/FpML-5/merged}StubValue" minOccurs="0"/&gt;
 *           &lt;/sequence&gt;
 *           &lt;element name="finalStub" type="{http://www.fpml.org/FpML-5/merged}StubValue"/&gt;
 *         &lt;/choice&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
...
public class StubCalculationPeriodAmount {
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "calculationPeriodDatesReference", namespace = "http://www.fpml.org/FpML-5/merged", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "initialStub", namespace = "http://www.fpml.org/FpML-5/merged", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "finalStub", namespace = "http://www.fpml.org/FpML-5/merged", type = JAXBElement.class, required = false)
    })
     ...
     * line 1499 of jar:file:/Users/hugohills/.m2/repository/org/finos/cdm/cdm-java/0.0.0.master-SNAPSHOT/cdm-java-0.0.0.master-SNAPSHOT.jar!/schemas/fpml-5-10/confirmation/fpml-ird-5-10.xsd
     * line 1493 of jar:file:/Users/hugohills/.m2/repository/org/finos/cdm/cdm-java/0.0.0.master-SNAPSHOT/cdm-java-0.0.0.master-SNAPSHOT.jar!/schemas/fpml-5-10/confirmation/fpml-ird-5-10.xsd
     * <p>
