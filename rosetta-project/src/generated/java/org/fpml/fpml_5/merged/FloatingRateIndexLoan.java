 ...
 *       &lt;attribute name="floatingRateIndexScheme" type="{http://www.fpml.org/FpML-5/merged}NonEmptyURI" default="http://www.fpml.org/coding-scheme/floating-rate-index-loan" /&gt;
 *     &lt;/extension&gt;
 *   &lt;/simpleContent&gt;
 * &lt;/complexType&gt;
 * </pre>
...
public class FloatingRateIndexLoan {
    ...
    public String getFloatingRateIndexScheme() {
        if (floatingRateIndexScheme == null) {
            return "http://www.fpml.org/coding-scheme/floating-rate-index-loan";
        } else {
