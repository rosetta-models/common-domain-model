 ...
 *         &lt;element name="dividendEntitlement" type="{http://www.fpml.org/FpML-5/merged}DividendEntitlementEnum" minOccurs="0"/&gt;
 *         &lt;element name="dividendAmount" type="{http://www.fpml.org/FpML-5/merged}DividendAmountTypeEnum" minOccurs="0"/&gt;
 *         &lt;element name="dividendPaymentDate" type="{http://www.fpml.org/FpML-5/merged}DividendPaymentDate" minOccurs="0"/&gt;
 *         &lt;choice&gt;
 *           &lt;sequence&gt;
 *             &lt;element name="dividendPeriodEffectiveDate" type="{http://www.fpml.org/FpML-5/merged}DateReference" minOccurs="0"/&gt;
 *             &lt;element name="dividendPeriodEndDate" type="{http://www.fpml.org/FpML-5/merged}DateReference" minOccurs="0"/&gt;
 *           &lt;/sequence&gt;
 *           &lt;element name="dividendPeriod" type="{http://www.fpml.org/FpML-5/merged}DividendPeriodEnum"/&gt;
 *         &lt;/choice&gt;
 *         &lt;element name="extraOrdinaryDividends" type="{http://www.fpml.org/FpML-5/merged}PartyReference" minOccurs="0"/&gt;
 *         &lt;element name="excessDividendAmount" type="{http://www.fpml.org/FpML-5/merged}DividendAmountTypeEnum" minOccurs="0"/&gt;
 *         &lt;group ref="{http://www.fpml.org/FpML-5/merged}CurrencyAndDeterminationMethod.model" minOccurs="0"/&gt;
 *         &lt;element name="dividendFxTriggerDate" type="{http://www.fpml.org/FpML-5/merged}DividendPaymentDate" minOccurs="0"/&gt;
 *         &lt;element name="interestAccrualsMethod" type="{http://www.fpml.org/FpML-5/merged}InterestAccrualsCompoundingMethod" minOccurs="0"/&gt;
 *         &lt;element name="numberOfIndexUnits" type="{http://www.fpml.org/FpML-5/merged}NonNegativeDecimal" minOccurs="0"/&gt;
 *         &lt;group ref="{http://www.fpml.org/FpML-5/merged}DeclaredCashAndCashEquivalentDividendPercentage.model"/&gt;
 *         &lt;element name="nonCashDividendTreatment" type="{http://www.fpml.org/FpML-5/merged}NonCashDividendTreatmentEnum" minOccurs="0"/&gt;
 *         &lt;element name="dividendComposition" type="{http://www.fpml.org/FpML-5/merged}DividendCompositionEnum" minOccurs="0"/&gt;
