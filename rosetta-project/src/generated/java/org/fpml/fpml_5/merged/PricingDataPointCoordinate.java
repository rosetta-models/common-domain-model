 ...
 *       &lt;sequence&gt;
 *         &lt;group ref="{http://www.fpml.org/FpML-5/merged}PricingStructureIndex.model" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
...
public class PricingDataPointCoordinate {
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "term", namespace = "http://www.fpml.org/FpML-5/merged", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "expiration", namespace = "http://www.fpml.org/FpML-5/merged", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "strike", namespace = "http://www.fpml.org/FpML-5/merged", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "generic", namespace = "http://www.fpml.org/FpML-5/merged", type = JAXBElement.class, required = false)
    })
